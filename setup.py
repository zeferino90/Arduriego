...
while command != 'exit':
    ...
    if command == "season" or command == 's':
        ...
        #llegir disc
        print ("1: Summer [april to september]: Plants will be watered from " + str(seasons["summer"][0]) + " to " + str(seasons["summer"][1]))
        print ("2: Winter [october to march]: Plants will be watered from " + str(seasons["winter"][0]) + " to " + str(seasons["winter"][1]))
